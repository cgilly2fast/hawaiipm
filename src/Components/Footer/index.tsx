  ...
  <>
    <div className="min-h-[280px] bg-Neutral200">
      <div className='block sm:flex pt-[50px] pt-[30px] pl-[20px]'>
        <div className='block sm:flex flex-row w-full justify-evenly'>
          <div>
            <img src={FooterLogoIcon} alt='logo' className='w-[150px] sm:w-[100%]' />
          </div>
          <div className='sm:max-w-[700px] w-full flex font-Arial flex-wrap justify-start'>
        ...
        <div className='border-t-2'>
          <div className='font-Arial justify-around pt-[30px] block sm:flex pl-[20px] sm:pl-[0px]'>
            <div className='flex text-[14px] items-start'>
              <img src={VectorIcon} alt='vector' /><div className='text-Black400 pl-[5px]'>2019 Hawaii Property Management LLC. All rights reserved.</div>
            </div>
