      ...
      <div className="pt-[20px] font-Arial">
        <div>
          <input
            ...
            className="w-[250px] md:w-[400px] lg:w-[510px] h-[44px] border-2 rounded-lg"
          />
        </div>
        ...
        <div className="lg:flex pt-[20px]">
          <div className="text-Neutral000 lg:text-Black100">
        ...
        <div className="pt-[20px]">
          <button
            className="w-[250px]  md:w-[400px] lg:w-[510px] h-[44px] bg-Green100 text-Neutral000 rounded-lg"
            onClick={() => {
              setOpen(open + 1);
            }}
          >
