...
const Plandata = [
  {
    id: 1,
    pictures: ShieldLockIcon,
    text: 'We protect homeowners',
    content:
      'We do frequent inspections with checklists, install smart locks for vacation rentals, and keep you informed of the properties performance and status.',
  },
  {
    id: 2,
    pictures: VerifiedIcon,
    text: 'Renters are verified',
    content:
      'Hawaii PM only allows kind, laid back renters that can pass ID screening, credit check, and have verified income to stay in your home. This catches bad actors before they can even make a booking or sign a lease.',
  },
  {
    id: 3,
    pictures: ClockIcon,
    text: 'Save you time',
    content:
      'At Hawaii PM, we takes care of all the day-to-day tasks of managing your property, allowing you to sit back and relax while we handle everything making your investment become truly passive.',
  },
];
...
const PlanDetail: React.FC = () => (
  <div className=" mx-auto max-w-[1920px] 2xl:px-80 xl:px-60 lg:px-32 pl-[20px] pr-[20px]">
    ...
    <div className="pt-[50px] font-Arial text-center">
      <button className="w-[250px] lg:w-[250px] h-[44px] text-Green100 border-2 border-Green100 rounded-lg text-[16px] outline-none">
    ...
    <div className="md:flex flex-row justify-between mx-auto max-w-[960px] pt-[50px]">
      <div className="mr-10">
        <img
          src={MaskGroup}
          alt="Owner"
