  ...
  <div className='relative'>
    ...
    <div className='text-Black400 bg-Neutral200 sm:flex flex-col items-center p-[10px] h-[40px] hidden md:hidden lg:block lg:flex flex-col items-center'>
      <div className='w-[650px] flex justify-between flex-row items-center font-Arial'>
        <div>Resident Login</div>
        <div>Realtor Referrals</div>
        <div className='w-[94px] flex justify-between'>
          <img src={TenantsIcon} alt='Tenants' /> <div>Tenants</div> <img src={DownArrowIcon} alt='down' /></div>
        <div className='w-[89px] flex justify-between' > <img src={UserIcon} alt='user' /> <div>Owners</div> <img src={DownArrowIcon} alt='down' /></div>
        <div>Blog</div>
        <div>415-209-5847</div>
      </div>
    </div>
          ...
          <Menu as="div" className="relative inline-block text-left">
            <div>
              <Menu.Button className="inline-flex w-full justify-center">
                <img src={MenuIcon} alt='manu' className="-mr-1 h-5 w-5 text-gray-400" aria-hidden="true" />
              </Menu.Button>
            </div>
        ...
        <Menu as="div" className="relative inline-block text-left">
          <div>
            <Menu.Button className="inline-flex w-full justify-center hover:bg-gray-50">
              Options
              <img src={DownArrowIcon} alt='down' className="-mr-1 h-5 w-5 text-gray-400" aria-hidden="true" />
            </Menu.Button>
          </div>
