...
const xyz = [
  [{ id: 1, pictures: User, name: 'Kathryn Murphy', text: "Acme Corporation", content: 'Lorem ipsum dolor sit amet consectetur. Proin consequat amet elementum elementum magna et morbi massa. Praesent at tellus habitasse commodo faucibus eros cursus faucibus. Molestie in nibh tincidunt at. Magna tincidunt tellus nisl eget praesent mi.' },
  { id: 2, pictures: User, name: 'Leslie Alexander', text: "C.A.G Novus", content: 'Lorem ipsum dolor sit amet consectetur. Egestas nulla lobortis adipiscing nunc nulla neque. Egestas tristique ipsum dictum fermentum ultrices. Sagittis posuere aliquet enim aliquet blandit enim arcu suscipit diam. Sed in viverra eget purus. Lorem volutpat fermentum malesuada praesent viverra habitasse felis at. Risus enim consequat cras ut sem risus senectus cursus. Integer ultrices mauris justo vitae odio in.' },
  { id: 3, pictures: User, name: 'Cody Fisher', text: "Forrit", content: 'Lorem ipsum dolor sit amet consectetur. Proin consequat amet elementum elementum magna et morbi massa. Praesent at tellus habitasse commodo faucibus eros cursus faucibus. Molestie in nibh tincidunt at. Magna tincidunt tellus nisl eget praesent mi.' },],
  [{ id: 4, pictures: User, name: 'Jane Cooper', text: "Clerk.io", content: 'Lorem ipsum dolor sit amet consectetur. Egestas nulla lobortis adipiscing nunc nulla neque. Egestas tristique ipsum dictum fermentum ultrices. Sagittis posuere aliquet enim aliquet blandit enim arcu suscipit diam. Sed in viverra eget purus. Lorem volutpat fermentum malesuada praesent viverra habitasse felis at. Risus enim consequat cras ut sem risus senectus cursus. Integer ultrices mauris justo vitae odio in.' },
  { id: 5, pictures: User, name: 'Cameron Williamson', text: "Solid Media AS", content: 'Lorem ipsum dolor sit amet consectetur. Proin consequat amet elementum elementum magna et morbi massa. Praesent at tellus habitasse commodo faucibus eros cursus faucibus. Molestie in nibh tincidunt at. Magna tincidunt tellus nisl eget praesent mi.' },
  { id: 6, pictures: User, name: 'Devon Lane', text: "Mediafy", content: 'Lorem ipsum dolor sit amet consectetur. Proin consequat amet elementum elementum magna et morbi massa. Praesent at tellus habitasse commodo faucibus eros cursus faucibus. Molestie in nibh tincidunt at. Magna tincidunt tellus nisl eget praesent mi.' }],
  [{ id: 7, pictures: User, name: 'Wade Warren', text: "LM Care", content: 'Lorem ipsum dolor sit amet consectetur. Proin consequat amet elementum elementum magna et morbi massa. Praesent at tellus habitasse commodo faucibus eros cursus faucibus. Molestie in nibh tincidunt at. Magna tincidunt tellus nisl eget praesent mi.' },
  { id: 8, pictures: User, name: 'Jenny Wilson', text: "MT Sales", content: 'Lorem ipsum dolor sit amet consectetur. Proin consequat amet elementum elementum magna et morbi massa. Praesent at tellus habitasse commodo faucibus eros cursus faucibus. Molestie in nibh tincidunt at. Magna tincidunt tellus nisl eget praesent mi.' },
  { id: 9, pictures: User, name: 'Theresa Webb', text: "Tilitoimisto Lemon Tree Oy", content: 'Lorem ipsum dolor sit amet consectetur. Egestas nulla lobortis adipiscing nunc nulla neque. Egestas tristique ipsum dictum fermentum ultrices. Sagittis posuere aliquet enim aliquet blandit enim arcu suscipit diam. Sed in viverra eget purus. Lorem volutpat fermentum malesuada praesent viverra habitasse felis at. Risus enim consequat cras ut sem risus senectus cursus. Integer ultrices mauris justo vitae odio in.' }]
]
