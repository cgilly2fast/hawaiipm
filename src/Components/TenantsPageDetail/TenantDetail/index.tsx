    ...
    <div className='lg:container 2xl:pl-80 xl:pr-0 xl:pl-40 pt-[50px] pl-[20px] pr-[20px]'>
      <div className='xl:flex flex-row'>
        ...
        <div className='text-Black400 font-Arial w-auto xl:pl-[70px] xl:pt-[0px] pt-[30px]'>
          <div className='font-Leitura text-Black100 text-[24px] font-bold'>
            Thank You for considering one of Hawaii PM's rental unit as your potential new home.
          </div>
      ...
      <div className='font-Arial pt-[20px]'>
        <div>
          <span className='font-bold'>IMPORTANT:</span> Please thoroughly read and follow <span className='font-bold'>"Important Requirements and Instructions"</span> section on the application form. If you have any questions please contact <span className='text-Green100'>colbygbemail@email.com</span> or <span className='text-Green100'>000-000-0000.</span>
        </div>
        <div className='pt-[20px]'>
          By clicking on the Apply Online button below a new browser window or tab will open up that will take you to our partner site where you can apply and pay the application fee. To return to the Pinnacle website tab, please close that browser.
        </div>
      </div>
