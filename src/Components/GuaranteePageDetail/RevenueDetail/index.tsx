...
const RevenueDetail: React.FC = () => (
  <div>
    ...
    >
      <div className="w-auto top-[30px] left-[13px] right-[13px] flex flex-col text-center absolute 2xl:flex 2xl:top-[40px] 2xl:left-[1060px] items-center rounded-lg items-start xl:flex xl:left-[780px] xl:top-[35px] lg:w-[470px] md:w-[370px] lg:flex bg-Neutral000 lg:top-[45px] lg:left-[400px] md:flex md:left-[340px] md:top-[30px]">
