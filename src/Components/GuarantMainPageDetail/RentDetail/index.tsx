...
const RentDetail: React.FC = () => (
  <div>
    <div className='relative w-full h-[432px] xl:h-[398px] lg:h-[400px]' style={{ backgroundImage: `url(${Background})` }}>
      <div className=''>
        <div className='font-Arial absolute top-[128px] left-[375px]'>
          <div className='text-[30px] text-Neutral000'>
            960 Kanakou PI
          </div>
          ...
          <div className='pl-[30px] pr-[30px] pt-[30px]'>
            ...
            <div className='flex pt-[20px]'>
              ...
              <div className='flex items-center pl-[10px]'>
                <div className='text-[16px]'>per month</div><img src={Question} alt='Question' className='pl-[10px]'/>
              </div>
            </div>
            ...
            <div className='pt-[20px]'>
              <button className='w-[250px]  md:w-[400px] lg:w-[310px] h-[44px] bg-Green100 text-Neutral000 rounded-lg'>List your home for rent</button>
            </div>
            <div className='text-[14px] pt-[10px]'>
              Are you the owner? Claim your home to edit beds, baths, and square footage.
            </div>
          </div>
        </div>
      </div>
