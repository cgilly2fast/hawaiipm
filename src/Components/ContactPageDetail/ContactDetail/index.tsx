...
const ContactDetail: React.FC = () => (
  <div className="pb-[50px]">
    ...
    <div className="lg:container 2xl:pl-80 xl:pr-0 xl:pl-40 pt-[30px] pl-[20px] pr-[20px]">
      <div className="md:flex">
        <div>
          <div className="font-Leitura text-[24px] font-bold">Contact Form</div>
          <div className="lg:flex font-Arial">
          <div className="h-[44px] p-[10px] border-2 rounded-lg">
              <input
                placeholder="Name"
                className="w-[100%] md:w-[260px] focus-visible:outline-none focus:outline"
              />
            </div>
            <div className="h-[44px] p-[10px] ml-[10px] border-2 rounded-lg">
              <input
                placeholder="Email"
                className="w-[100%] md:w-[260px] focus-visible:outline-none focus:outline"
              />
        ...
        <div className="md:pl-[70px]">
          <div className="font-Leitura text-[24px] font-bold pt-[10px]">
            Contact info
          </div>
